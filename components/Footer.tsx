      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-primary mb-4">Hill Rides Nainital</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              Experience the freedom of riding through scenic hills and beautiful landscapes with our premium bike and scooty rental service in Nainital.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/fleet" className="text-gray-300 hover:text-primary transition-colors">Fleet</Link></li>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <p>🏔️ Nainital, India</p>
              <p>📞 +91 86188 79146</p>
              <p>✉️ info@hillridesnainital.com</p>
            </div>
          </div>
        </div>

        <div className="border-t border-gray-800 dark:border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Hill Rides Nainital. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
